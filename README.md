...
##  Python Script : MonteCarelo Simulations, API Keys,Optimized Weights,etcNokey
...
##  Python Script : APikeys,QueryingWithSQL,Crspr
...
## Python Script : APIRequest&DefiningFunctionsUsingFMPLibaryWithNoKey
...
## Python Script : Arima,ETS, and Prophet Model TrainingUsingFred
...
## Python Script : DCF's & ValuationWithnokey
...
## Python Script : Examples of taking portfolios and graphing Indicators and Bollinger Bands
...
## Python Script : Fama-French Three-Factor Data RegressionTraining
...
## Python Script : FF5 OLS Regression training
...
![image](https://github.com/user-attachments/assets/d577676b-8e72-4c2b-8673-ab3774531a44)
![image](https://github.com/user-attachments/assets/4de50afc-586d-45c8-8a41-6c444bf8e133)
